trigger AccountTrigger on Account (before delete, before insert, after insert) {
   ...
   // if(Trigger.isBefore) {
    //    if(Trigger.isDelete) {
    //        AccountDeletionValidator.preventAccountDeletionIfHaveChildren(Trigger.old);
   //     } //else if(Trigger.isInsert) {
            //AccountChecker.accountNeedsBillingCity(Trigger.new);
       // }
  //  } else {
   //     if(Trigger.isInsert) {
    //        AccountHandler.postToChatterAfterCreation(Trigger.new);
    //    }
   // }
